...
image:openshift_acc-operator_details.png["이 이미지는 Astra Control Center 탭이 선택된 Astra Control Center 운영자 페이지를 보여줍니다"]
...
.. Astra Control Center 버전(예: 23.10.0-68)을 입력합니다.
